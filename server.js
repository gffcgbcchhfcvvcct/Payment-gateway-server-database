...
const SUPABASE_SERVICE_KEY = 'sb_secret_hVB1jl9e6RVzDplr1VDzrw_mS7Ty_bF';
...
app.listen(PORT, () => {
  ...
  console.log(`Frontend: https://nexapay-bridge.onrender.com/auth.html`);
  console.log(`Dashboard: https://nexapay-bridge.onrender.com/dashboard.html`);
  console.log(`Backend API: https://nexapay-server.onrender.com/api/health`);
});
